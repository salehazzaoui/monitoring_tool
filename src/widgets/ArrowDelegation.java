...
public class ArrowDelegation extends Line {
    ...
    public ArrowDelegation(PortBlock portOut, PortBlock portIn, Port out, Port in, Component componentSrc, Component componentDes){
        ...
        startX = portOut.getLayoutX() + portOut.getWidth() / 2;
        startY = portOut.getLayoutY() + portOut.getHeight() / 2;
        ...
        System.out.println("des X = "+this.componentDes.getX());
        System.out.println("des Y = "+this.componentDes.getY());
